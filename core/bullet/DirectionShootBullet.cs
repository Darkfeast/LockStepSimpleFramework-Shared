...
public class DirectionShootBullet : BaseBullet
{
    ...
    // @param poDst 发射的目标位置
    // @return none.
    public override void Init(LiveObject src, LiveObject dest, FixVector3 poOri, FixVector3 poDst)
    {
        base.Init(src, dest, poOri, poDst);
        ...
        moveTo(m_fixv3SrcPosition, m_fixv3DestPosition, m_fixMoveTime, delegate() { doShootDest(); });
    }
